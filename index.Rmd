--- 
title: "Research Methods and GIS with R"
author: "Michael Hunt (with an enormous debt to Dylan Childs of Sheffield University Dept. Plant and Anaimal Sciences, from whose examples I learned how to do this and from which this currently is partly a straight copy)"
date: "`r Sys.Date()`"
...
link-citations: yes
github-repo: mbh038/rmgis
description: "Course book for CORN276 Research Methods and GIS at Cornwall College Newquay"
---


# Course information and overview

This is the online course book for the __CORN 276 Research Methods and GIS__  module. You can view this book in any modern desktop browser, as well as on your phone or tablet device.

## Why do this course? {#why-do-this-course}

We want you to develop the key skills of being a scientist. That means that you need some understanding of how to ask questions and of the the principles of experimental design, data collection, statistical analysis and scientific presentation.

By the end of this course we don't expect that you will be an expert in any of these topics, much less be a maths wizard or a computer genius, but we do hope that by the end of this course you will be able to make sensible decisions about designing studies, collecting data and then being able to analyse, present and interpret these data correctly.

By the end, you will also have used a variety of analytical techniques, and have had some hands-on experience of using the statistical analysis software R that is currently the most widely used for analysis in the life sciences.

This will set you in good stead for your honours project next year.
...
It is up to you to complete the preparatory reading in your own time. You are not expected to understand everything when you first encounter it. Do your best to understand it, taking careful notes of anything you're struggling with. The staff will happily answer any questions you have via the chat on Teams.

#### Interactive **learnr** tutorials

An interactive **learnr** tutorial will be provided each week to provide you with the opportunity to practise applying the ideas you have been reading about and consolidate your learning. Details of how to access and run these are provided on Teams.
...
-   Use the discussion boards on Teams to ask teaching staff for help if there are things you don’t follow, or when things don’t seem to come out the way they should---that’s what the staff are there for!
...
-   Complete each week’s work before the next week’s session. You may be able to complete some sessions quite quickly, others may take more time and require more effort from you.
...
You will be able to access 'live', online drop-in sessions several times a week, during which you can ask questions about any conceptual or practical aspect of the course causing you problems. These sessions will be run by the course team. Details of these sessions will be posted on Teams.
