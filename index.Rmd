...
By the end of this course we don't expect that you be an expert in any of these topics, much less be a maths wizard or a computer genius, but we do expect that you will be able to make sensible decisions about designing studies, collecting data and then being able to interpret these data correctly.

You will have used a variety of analytical techniques,
